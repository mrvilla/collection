...
export { forEach, indexOf, checkElementInContext, getParamFromUrl, querySelectorArray, updateUrl, getComputedTranslate, animationEndEvent, detectSwipe, isInViewport, isOffscreen, isTouch, transitionEndEvent, methodExtend, mixin, defaults, extend, throttle, capitalizeFirstLetter, hyphenate, toCamelCase, makeId, regExp };
